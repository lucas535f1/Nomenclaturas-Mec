        ...
        <section class="dataSection">
            ...
            <div class="dataContainer">
                ...
                <div style="grid-area: boton;">
                    <a href="./editarArea.php?id=<?= $oficina['ID'] ?>">
    ...
    <script>
        function eliminar() {
            if (confirm("Se eliminara deifinitivamente ¿Esta seguro?")) {
                $.ajax({
                    type: "post",
                    url: "./includes/areaEliminar.inc.php",
                    dataType: "json",
                    data: {
                        id: <?= $_GET['id'] ?>
                    },
